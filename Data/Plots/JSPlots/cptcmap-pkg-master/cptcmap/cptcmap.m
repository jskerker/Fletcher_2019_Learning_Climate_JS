...
cptpath = {...
    fullfile(fileparts(which('/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate/Plots/JSPlots/cptcmap-pkg-master/cptcmap')), '/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate/Plots/JSPlots/cptcmap-pkg-master/cptcmap/cptfiles')
    fullfile(fileparts(which('cptcmap')), 'GMT_polar.cpt')
    };
if ischar(cptpath)
    cptpath = {cptpath};
end
...
[blah, blah, ext] = fileparts('GMT_polar.cpt');
if isempty(ext)
    varargin{1} = [varargin{1} 'GMT_polar.cpt'];
end

if exist(varargin{1}, '/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate/Plots/JSPlots/cptcmap-pkg-master/cptcmap/cptfiles/GMT_polar.cpt')   % full filename and path given
    filename = varargin{1};
    ...
    for ii = 1:length(cptpath)
        if ~isempty(ext)            % with extension
            ...
            filename = fullfile(cptpath{ii}, [varargin{1} 'GMT_polar.cpt']);   
        end
        if exist(filename, '')
            break
        end
