...
%T85P45
load('results_nonopt_T85P45_25_Mar_2021_00_40_09.mat');
shortageCostTime_45_0 = shortageCostTime;
action_T85P45 = action;
% Regret for last time period
bestOption = 0;
...
%T45P85
load('results_nonopt_T45P85_25_Mar_2021_16_12_43.mat');
shortageCostTime_85_0 = shortageCostTime;
action_T45P85 = action;
% Regret for last time period
bestOption = 0;
...
for i=1:5
    C_counts_RCP85(i, :) = histcounts(action_RCP85(:,i,4), s_C_bins);
    C_counts_RCP45(i, :) = histcounts(action_RCP45(:,i,4), s_C_bins);
    C_counts_T85P45(i, :) = histcounts(action_T85P45(:,i,4), s_C_bins);
    C_counts_T45P85(i, :) = histcounts(action_T45P85(:,i,4), s_C_bins);
end
