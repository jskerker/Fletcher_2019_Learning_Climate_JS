...
if ~isempty(getenv('SLURM_JOB_ID'))
    projpath = '/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate';
else
    projpath = '/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate';
end
...
runParam.shortageLoadName = 'shortage_costs_01_Dec_2020_14_18_47';
...
% Keep this on, or remove the check, so that bins are always checked.
...
P_abs_max = max(s_P) * N;
s_P_abs = 66:1:97; %change this line for testing- Nov 22
...
if ~runParam.desalOn
    ...
    [infra_cost(4), infra_cost(5)] = storage2damcost(storage(1), storage(2), costParam.PercFlex, costParam.PercFlexExp);
...
if runParam.calcTmat
    load('BMA_code/BMA_results_RCP85_2020-11-14.mat')
    [T_Temp, T_Precip, ~, ~, ~, ~] = bma2TransMat( NUT, NUP, s_T, s_P, N, climParam);
    save('T_Temp_Precip_RCP85B', 'T_Temp', 'T_Precip')    
else
    load('T_Temp_Precip_mod2') 
end
...
if runParam.saveOn
    ...
    savename_results = strcat('results_mod2_',datetime, '.mat');
...
%load('BMA_code/BMA_results_RCP85_2020-11-14.mat', 'MUT', 'MUP')

% initialize using RCP8.5 MUT or MUP
...
% RCP4.5 MUT or MUP
%load('/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Mombasa_climate/BMA_code/BMA_results_RCP85_2020-11-11.mat', 'MUP')
