...
load('/Users/jenniferskerker/Documents/GradSchool/Research/Project1/Code/Models/Fletcher_2019_Learning_Climate/Data/Mombasa_TandP-45-85.mat')
...
ylabel('^oC')
ylim([22, 30])
sgtitle('Absolute Comparison')
print('AbsComparison','-dpdf','-fillpage')
...
ylabel('^oC')
ylim([-.5, 6])
sgtitle('Delta Comparison')
print('DeltaComparison','-dpdf','-fillpage')